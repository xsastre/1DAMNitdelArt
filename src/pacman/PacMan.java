...
public class PacMan extends Applet implements Runnable
{
  ...
  final short   level1data[] = {
	35,26,26,22, 9,12,19,26,22, 9,12,19,26,26,22,
  ...
  public void GetImages()
  {
    ...
    ghost1=getImage(getDocumentBase(),"../image/Ghost1.gif");
    thetracker.addImage(ghost1,0);
    ghost2=getImage(getDocumentBase(),"../image/Ghost2.gif");
    thetracker.addImage(ghost2,0);
    ghostscared1=getImage(getDocumentBase(),"../image/GhostScared1.gif");
    thetracker.addImage(ghostscared1,0);
    ghostscared2=getImage(getDocumentBase(),"../image/GhostScared2.gif");
    thetracker.addImage(ghostscared2,0);
    pacman1=getImage(getDocumentBase(),"../image/PacMan1.gif");
    thetracker.addImage(pacman1,0);
    pacman2up=getImage(getDocumentBase(),"../image/PacMan2up.gif");
    thetracker.addImage(pacman2up,0);
    pacman3up=getImage(getDocumentBase(),"../image/PacMan3up.gif");
    thetracker.addImage(pacman3up,0);
    pacman4up=getImage(getDocumentBase(),"../image/PacMan4up.gif");
    thetracker.addImage(pacman4up,0);
    pacman2down=getImage(getDocumentBase(),"../image/PacMan2down.gif");
    thetracker.addImage(pacman2down,0);
    pacman3down=getImage(getDocumentBase(),"../image/PacMan3down.gif");
    thetracker.addImage(pacman3down,0);
    pacman4down=getImage(getDocumentBase(),"../image/PacMan4down.gif");
    thetracker.addImage(pacman4down,0);
    pacman2left=getImage(getDocumentBase(),"../image/PacMan2left.gif");
    thetracker.addImage(pacman2left,0);
    pacman3left=getImage(getDocumentBase(),"../image/PacMan3left.gif");
    thetracker.addImage(pacman3left,0);
    pacman4left=getImage(getDocumentBase(),"../image/PacMan4left.gif");
    thetracker.addImage(pacman4left,0);
    pacman2right=getImage(getDocumentBase(),"../image/PacMan2right.gif");
    thetracker.addImage(pacman2right,0);
    pacman3right=getImage(getDocumentBase(),"../image/PacMan3right.gif");
    thetracker.addImage(pacman3right,0);
    pacman4right=getImage(getDocumentBase(),"../image/PacMan4right.gif");
